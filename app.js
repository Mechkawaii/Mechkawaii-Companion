...
(function(){
  const PRESET_MAPS = [
  { id: "01", title_fr: "Giga Centrale Électrique⚡️", title_en: "Giga Centrale Électrique⚡️", lore_fr: "L’une des plus vastes centrales d’énergie de l’univers Mechkawaii. Ces installations colossales alimentent les métropoles grouillantes de vie et font tourner l’infrastructure des mégacités.
Mais leur importance en fait aussi des cibles stratégiques. Les Prodromes, toujours en quête de chaos, cherchent régulièrement à saboter ou capturer ces centrales pour plonger les villes dans l’obscurité… et affaiblir la résistance des habitants.", lore_en: "L’une des plus vastes centrales d’énergie de l’univers Mechkawaii. Ces installations colossales alimentent les métropoles grouillantes de vie et font tourner l’infrastructure des mégacités.
Mais leur importance en fait aussi des cibles stratégiques. Les Prodromes, toujours en quête de chaos, cherchent régulièrement à saboter ou capturer ces centrales pour plonger les villes dans l’obscurité… et affaiblir la résistance des habitants.", img: "./assets/terrain/presets/01.png" },
  { id: "02", title_fr: "Grande Route Logistique 🚚", title_en: "Grande Route Logistique 🚚", lore_fr: "Principaux axes d’approvisionnement. Ces immenses routes industrielles transportent en continu des cargaisons précieuses : matériaux de construction, pièces mécaniques et modules d’armement destinés aux gigantesques Génématrices – ces machines titanesques capables d’imprimer bâtiments, infrastructures et même parties d’unités de combat.
...
Mais une route si cruciale attire forcément les convoitises. Les Prodromes savent que frapper ici, c’est bloquer toute une chaîne de production. Embuscades, pillages et sabotages transforment fréquemment ce corridor en champ de bataille.", img: "./assets/terrain/presets/02.png" },
  { id: "03", title_fr: "La Zone Cendrée 🌑", title_en: "La Zone Cendrée 🌑", lore_fr: "Les vestiges d’un quartier entier réduit en poussière. Les façades calcinées tiennent à peine debout, et un voile gris recouvre chaque ruelle. Le silence est seulement brisé par l’écho métallique des pas et le craquement des débris qui s’effondrent.
Les Prodromes aiment s’y aventurer car les cendres opaques brouillent la visibilité et masquent leurs mouvements.", lore_en: "Les vestiges d’un quartier entier réduit en poussière. Les façades calcinées tiennent à peine debout, et un voile gris recouvre chaque ruelle. Le silence est seulement brisé par l’écho métallique des pas et le craquement des débris qui s’effondrent.
Les Prodromes aiment s’y aventurer car les cendres opaques brouillent la visibilité et masquent leurs mouvements.", img: "./assets/terrain/presets/03.png" },
  { id: "04", title_fr: "L’Usine Silencieuse 🏭", title_en: "L’Usine Silencieuse 🏭", lore_fr: "Immense bâtiment industriel déserté, ses halls obscurs sont remplis de poutres tordues et de machines éventrées. L’air est chargé de poussière et de suie, vestiges d’une activité qui ne reprendra jamais.
Les Mechkawaii la protège car ses ruines recèlent encore des ressources rares, pièces mécaniques et énergie dormante.", lore_en: "Immense bâtiment industriel déserté, ses halls obscurs sont remplis de poutres tordues et de machines éventrées. L’air est chargé de poussière et de suie, vestiges d’une activité qui ne reprendra jamais.
Les Mechkawaii la protège car ses ruines recèlent encore des ressources rares, pièces mécaniques et énergie dormante.", img: "./assets/terrain/presets/04.png" },
  { id: "05", title_fr: "Le Cratère Noir ⚫", title_en: "Le Cratère Noir ⚫", lore_fr: "Une explosion titanesque a éventré cette zone, ne laissant qu’un gouffre béant bordé de décombres noircis. Tout autour, les bâtiments sont tordus comme des silhouettes en souffrance, rappelant la violence de l’attaque.
Les Prodromes y voient un symbole de destruction à entretenir, un rappel constant de leur puissance et de leur menace.", lore_en: "Une explosion titanesque a éventré cette zone, ne laissant qu’un gouffre béant bordé de décombres noircis. Tout autour, les bâtiments sont tordus comme des silhouettes en souffrance, rappelant la violence de l’attaque.
Les Prodromes y voient un symbole de destruction à entretenir, un rappel constant de leur puissance et de leur menace.", img: "./assets/terrain/presets/05.png" },
  { id: "06", title_fr: "La Gare Fracturée 🚉", title_en: "La Gare Fracturée 🚉", lore_fr: "Les rails sont tordus, les wagons éventrés gisent de travers et l'édifice monumentale s’est effondrée. L’endroit résonne encore du vacarme des trains disparus.
Les Prodromes attaquent cette zone pour couper les réseaux de transport et isoler les cités entre elles.", lore_en: "Les rails sont tordus, les wagons éventrés gisent de travers et l'édifice monumentale s’est effondrée. L’endroit résonne encore du vacarme des trains disparus.
Les Prodromes attaquent cette zone pour couper les réseaux de transport et isoler les cités entre elles.", img: "./assets/terrain/presets/06.png" },
  { id: "07", title_fr: "La Place du Souvenir 🕯️", title_en: "La Place du Souvenir 🕯️", lore_fr: "Une grande esplanade autrefois dédiée aux cérémonies, aujourd’hui ravagée par des impacts d’obus. Les statues sont décapitées et les pavés éclatés par les flammes.
Les Prodromes aiment y frapper pour effacer les symboles de la mémoire collective et marquer leur domination psychologique.", lore_en: "Une grande esplanade autrefois dédiée aux cérémonies, aujourd’hui ravagée par des impacts d’obus. Les statues sont décapitées et les pavés éclatés par les flammes.
Les Prodromes aiment y frapper pour effacer les symboles de la mémoire collective et marquer leur domination psychologique.", img: "./assets/terrain/presets/07.png" },
  { id: "08", title_fr: "La Fosse d’Assemblage 🏭", title_en: "La Fosse d’Assemblage 🏭", lore_fr: "Vestige d’une usine souterraine, ses chaînes de montage sont figées et ses fosses grouillent de carcasses de mechas inachevés.
Les Prodromes cherchent à s’en emparer pour réactiver les machines et détourner leur production.", lore_en: "Vestige d’une usine souterraine, ses chaînes de montage sont figées et ses fosses grouillent de carcasses de mechas inachevés.
Les Prodromes cherchent à s’en emparer pour réactiver les machines et détourner leur production.", img: "./assets/terrain/presets/08.png" },
  { id: "09", title_fr: "Quartiers résidentiels 🏢", title_en: "Quartiers résidentiels 🏢", lore_fr: "Des gratte-ciel éventrés, dont la moitié des étages a disparu, laissant des squelettes métalliques. Ses ruines dominent encore toute la zone.
Les Prodromes en font un bastion, utilisant sa hauteur comme poste d’observation pour contrôler la ville.", lore_en: "Des gratte-ciel éventrés, dont la moitié des étages a disparu, laissant des squelettes métalliques. Ses ruines dominent encore toute la zone.
Les Prodromes en font un bastion, utilisant sa hauteur comme poste d’observation pour contrôler la ville.", img: "./assets/terrain/presets/09.png" },
  { id: "10", title_fr: "Les Grandes Archives", title_en: "Les Grandes Archives", lore_fr: "Colossales bâtisses autrefois dédiées au savoir, aujourd’hui ouvertes en deux par une frappe orbitale. Des piles de tablettes de données s’entassent dans les couloirs noircis.
Les Mechkawaii cherchent à la protéger car elle renferme encore des archives et des plans techniques cruciaux pour la reconstruction.", lore_en: "Colossales bâtisses autrefois dédiées au savoir, aujourd’hui ouvertes en deux par une frappe orbitale. Des piles de tablettes de données s’entassent dans les couloirs noircis.
Les Mechkawaii cherchent à la protéger car elle renferme encore des archives et des plans techniques cruciaux pour la reconstruction.", img: "./assets/terrain/presets/10.png" }
];
